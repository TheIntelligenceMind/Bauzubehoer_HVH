...
<div class="tabreiter">
    <ul>
        <li>
            ...
            <div>
			<input title="Vorname" class="inputField" type="text" name="vorname" placeholder="Vorname" readonly>
			<input title="Nachname" class="inputField" type="text" name="nachname" placeholder="Nachname" readonly>
			<input title="E-Mail" class="inputField" type="text" name="email" placeholder="eMail" readonly>
